...
public:
  ...
  explicit duckyParserParser(antlr4::TokenStream *input);

  duckyParserParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~duckyParserParser() override;
